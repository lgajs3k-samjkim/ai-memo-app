...
export default function Home() {
  ...
  const activeViewingMemo = viewingMemo
    ? (allMemos.find(memo => memo.id === viewingMemo.id) ?? viewingMemo)
    : null
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* 모달 폼 */}
      <MemoViewer
        memo={activeViewingMemo}
        isOpen={activeViewingMemo !== null}
        onClose={() => setViewingMemo(null)}
        onEdit={handleEditMemo}
        onSaveSummary={updateSummary}
      />
